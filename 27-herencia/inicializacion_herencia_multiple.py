...
print('Es lista ent ord?', isinstance(
    lista_enteros_ordenada, ListaEnterosOrdenada))
...
print('Es de varios tipos?', isinstance(
    lista_enteros_ordenada, (ListaEnteros, ListaSimple)))
