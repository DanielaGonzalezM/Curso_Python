...
def mi_funcion_lambda(a, b): return a + b
...
def mi_funcion_lambda(): return 'Función sin argumentos'
...
def mi_funcion_lambda(a=2, b=3): return a + b
...
print(f'Resultado argumentos variables: {
      mi_funcion_lambda(1, 2, 3, a=5, b=6)}')

# Funciones lambda con argumentos, argumentos variables y valores por default
mi_funcion_lambda = lambda a, b, c=3, * \
    args, **kwargs: a+b+c+len(args)+len(kwargs)
print(f'Resultado función lambda: {
      mi_funcion_lambda(1, 2, 4, 5, 6, 7, e=5, f=7)}')
