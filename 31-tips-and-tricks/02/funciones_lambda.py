...
lista_tuplas_ordenada = sorted(
    lista_tuplas, key=lambda tupla: tupla[1], reverse=True)
...
class Prueba:
    def mostrar(self): return print('Funcion mostrar...')
    def saludar(self): return print('Funcion saludar...')
