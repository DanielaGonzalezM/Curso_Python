...
def saludar(argumento_funcion):
    ...
    referencia_funcion_retornada = argumento_funcion(
        'Hola, saludos desde mi funcion')
...
print(f'Se puede llamar el objeto mostrar_ing como funcion?: {
      callable(mostrar_ing)}')
print(f'Se puede llamar el objeto str como funcion?: {
      callable("cualquier texto")}')
...
print(f'Se puede llamar el objeto mostrar_doctor como funcion?: {
      callable(mostrar_doctor)}')
