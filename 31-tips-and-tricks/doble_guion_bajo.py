...
if __name__ == '__main__':
    ...
    print(f'Variable privada usando name mangling: {
          padre._Padre__variable_privada}')
    ...
    print(f'Acceso privado desde hijo con name mangling: {
          hijo._Hijo__variable_privada}')
    print(f'Acceso privada desde hijo a la clase padre: {
          hijo._Padre__variable_privada}')
    ...
    prueba = Prueba()
    print(f'Accediendo variable global desde una clase: {
          prueba.obtener_variable()}')
